import { app, BrowserWindow, ipcMain, shell, powerMonitor, dialog, clipboard, nativeImage } from 'electron'
...
import {
  initPluginHost, listPlugins, togglePlugin, setPluginSetting,
